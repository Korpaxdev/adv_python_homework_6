documents = [
    ...
    {"type": "passport", "number": "5455 028765", "name": "Джон Доу"}
]
...
def move_doc_to_shelf():
    ...
    if check_document_existance(user_doc_number):
        ...
        return True
    print(f'Документа с номером - {user_doc_number} не найдено в базе')
    return False
...
def add_new_doc():
    ...
    if not check_document_existance(new_doc_number):
        new_doc = {
            "type": new_doc_type,
